...
public class sellerAcceptOrder_Controller{
	...
	public void setUsername(String username) {
	    ...
	    if (Main.System.productTransactions.isEmpty()) {
	        list.getItems().add("No orders available for approval.");
	        return;
	    }

	    boolean hasPendingOrders = false;
	    for (ProductTransaction transaction : Main.System.productTransactions) {
	        if (transaction.sellerName != null && transaction.sellerName.contentEquals(username) && !transaction.approved) {
	...
	public void approvesOrder(int orderId1) {
